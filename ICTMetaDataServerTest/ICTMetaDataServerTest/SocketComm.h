...
#define EVT_RECV_FIRSTDATA	0x0004  // Receive First data
#define EVT_RECV_ALIVE		0x0005  // Receive Alive data 
#define EVT_RECV_DIALOG		0x0006	//Dialog Create
...
struct stDataPacket
{
	...
	int			  encodeType; // reserved for des encode
	int           reserved0 ; // not used
...
public:
    ...
    bool ConnectTo(LPCTSTR strDestination, LPCTSTR strServiceName, int nProtocol, int nType, DWORD dwTimeout = 0);
